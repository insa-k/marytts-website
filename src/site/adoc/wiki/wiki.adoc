...
Transition from http://mary.opendfki.de/trac/[the old TRAC page] to this place is in progress; for the moment, you may want to look in both places for the information you care about.
...
* http://mary.opendfki.de/trac/wiki/ProsodySpecificationSupport[Support for explicit prosody specifications]
...
You can search past messages on the Mary-users or the Mary-developers lists, please have a look to the Mailing List section in http://mary.opendfki.de/trac/[the old TRAC page]